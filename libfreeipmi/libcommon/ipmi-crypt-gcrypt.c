...
int
gcrypt_hash (unsigned int hash_algorithm,
             ...
             unsigned int digest_len)
{
  ...
  assert (IPMI_CRYPT_HASH_ALGORITHM_VALID (hash_algorithm));
  assert (!hash_data || hash_data_len);
  assert (digest);
  assert (digest_len);
...
int
gcrypt_hash_digest_len (unsigned int hash_algorithm)
{
               ...
               int encrypt_flag)
{
  ...
  assert (IPMI_CRYPT_CIPHER_MODE_VALID (cipher_mode));
  assert (iv);
  assert (iv_len);
  assert (data);
  assert (data_len);
...
int
gcrypt_cipher_encrypt (unsigned int cipher_algorithm,
                       unsigned int cipher_mode,
                       const void *key,
                       unsigned int key_len,
                       const void *iv,
...
int
gcrypt_cipher_decrypt (unsigned int cipher_algorithm,
                       unsigned int cipher_mode,
                       const void *key,
                       unsigned int key_len,
                       const void *iv,
...
int
gcrypt_cipher_key_len (unsigned int cipher_algorithm)
{
  return (_crypt_cipher_info (cipher_algorithm, IPMI_CRYPT_CIPHER_INFO_KEY_LENGTH));
}

int
gcrypt_cipher_block_len (unsigned int cipher_algorithm)
{
