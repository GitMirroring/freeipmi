...
extern struct sel_string_oem sel_string_oem_gigabyte_mg20op0zb;
...
extern struct sel_string_oem sel_string_oem_intel_s2600wp;
                               ...
                               struct sel_string_oem **sel_string_oem)
{
  ...
  if (ctx->manufacturer_id == IPMI_IANA_ENTERPRISE_ID_DELL)
  ...
  else if (ctx->manufacturer_id == IPMI_IANA_ENTERPRISE_ID_GIGABYTE)
    {
      ...
      else if (ctx->product_id == IPMI_GIGABYTE_PRODUCT_ID_MG20_OP0_ZB)
        (*sel_string_oem) = &sel_string_oem_gigabyte_mg20op0zb;
    }
  else if (ctx->manufacturer_id == IPMI_IANA_ENTERPRISE_ID_INTEL)
    {
      ...
      else if (ctx->product_id == IPMI_INTEL_PRODUCT_ID_S2600WP)
        (*sel_string_oem) = &sel_string_oem_intel_s2600wp;
                          ...
                          unsigned int flags)
{
  ...
  int percent_flag = 0;
  unsigned int wlen = 0;
  struct sel_string_oem *sel_string_oem = NULL;
  int rv = -1;
  int ret;
