...
enum ipmi_monitoring_sensor_bitmask_threshold
  {
    ...
    IPMI_MONITORING_SENSOR_BITMASK_THRESHOLD_AT_OR_ABOVE_UPPER_NON_CRITICAL_THRESHOLD    = 0x0008,
    IPMI_MONITORING_SENSOR_BITMASK_THRESHOLD_AT_OR_ABOVE_UPPER_CRITICAL_THRESHOLD        = 0x0010,
    IPMI_MONITORING_SENSOR_BITMASK_THRESHOLD_AT_OR_ABOVE_UPPER_NON_RECOVERABLE_THRESHOLD = 0x0020,
  };
...
enum ipmi_monitoring_sensor_bitmask_version_change
  {
    ...
    IPMI_MONITORING_SENSOR_BITMASK_VERSION_CHANGE_HARDWARE_INCOMPATIBILITY_DETECTED_WITH_ASSOCIATED_ENTITY               = 0x0004,
    IPMI_MONITORING_SENSOR_BITMASK_VERSION_CHANGE_FIRMWARE_OR_SOFTWARE_INCOMPATIBILITY_DETECTED_WITH_ASSOCIATED_ENTITY   = 0x0008,
